 ...
 * Su uso es meramente ilustrativo y no tiene ninguna funcionalidad.
 * Autor original:
 * [aceternity](https://ui.aceternity.com/components/macbook-scroll)
 */
import {
  CaretDown,
  CaretLeft,
  ...
  return (
    <div className="mx-1 h-full rounded-md bg-[#050505] p-1">
      ...
      <Row>
        ...
        <KBtn>
          <MagnifyingGlass className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block">F4</span>
        </KBtn>
        <KBtn>
          <Microphone className="h-[6px] w-[6px]" />
        ...
        <KBtn>
          <TrackPreviousIcon className="h-[6px] w-[6px]" />
        ...
        <KBtn>
          <TrackNextIcon className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block">F8</span>
        </KBtn>
        <KBtn>
          <SpeakerNone className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block">F10</span>
        </KBtn>
        <KBtn>
          <SpeakerLow className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block">F11</span>
        </KBtn>
        <KBtn>
          <SpeakerHigh className="h-[6px] w-[6px]" />
      ...
      <Row>
        ...
        <div className="mt-[2px] flex h-6 w-[4.9rem] flex-col items-center justify-end rounded-[4px] p-[0.5px]">
          <KBtn className="h-3 w-6">
            <CaretUp weight="fill" className="h-[6px] w-[6px]" />
          </KBtn>
          <div className="flex">
            <KBtn className="h-3 w-6">
              <CaretLeft weight="fill" className="h-[6px] w-[6px]" />
            </KBtn>
            <KBtn className="h-3 w-6">
              <CaretDown weight="fill" className="h-[6px] w-[6px]" />
            </KBtn>
            <KBtn className="h-3 w-6">
              <CaretRight weight="fill" className="h-[6px] w-[6px]" />
            </KBtn>
          </div>
        </div>
      </Row>
